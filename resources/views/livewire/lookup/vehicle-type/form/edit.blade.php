    ...
    class='max-h-[95%] min-w-[350px] rounded-md shadow-md bg-white flex flex-col overflow-auto'>
        ...
        <div class='overflow-auto'>
            <div class='py-5 px-10 flex flex-col gap-5'>
                ...
                <div class='input-container'>
                    <div class='flex justify-between items-center'>
                        <label class='font-semibold'>Maks. Bobot Beban (Ton)</label>
                        @error ('max_cargo_weight_kg')
                            <div class='group/error relative flex items-center gap-2'>
                                <p class='error-message'>{{ $message }}</p>
                                <i class='bi-info-circle text-red-500'></i>
                            </div>
                    ...
                    <input wire:model.live='max_cargo_weight_kg' type='number' min='0' class='input-general @error('max_cargo_weight_kg') input-state-error @enderror input-state-normal'>
                </div>
            </div>
        </div>
